...
const HomeScreen = () => {
      ...
      <View>
        ...
        <View style={styles.container}>
          ...
          <TouchableOpacity style={styles.inputContainer}>
            ...
            <Text style={styles.inputLabel}>Select Your Dates</Text>
            <DatePicker
                style={{
                  width: 350,
                  height: 30,
  ...
  >
    <Text style={styles.searchButtonText}>Search</Text>
      ...
      <ModalPortal
        swipeThreshold={200}
        onBackdropPress={() => setModalVisibile(!modalVisible)}
        ...
        footer={
          <ModalFooter>
            <ModalButton
              ...
              onPress={() => setModalVisibile(!modalVisible)}
            />
          </ModalFooter>
        }
        ...
        onHardwareBackPress={() => setModalVisibile(!modalVisible)}
        visible={modalVisible}
        onTouchOutside={() => setModalVisibile(!modalVisible)}
      >
